...
OpenMedSpel is a medical spelling word list, designed to be used in conjuction with a standard USA English word list for spell checking.

The OpenMedSpel word list is provided as an ASCII file and a CSV file.
